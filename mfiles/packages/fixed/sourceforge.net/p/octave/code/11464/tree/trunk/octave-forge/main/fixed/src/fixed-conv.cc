...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/fixed-conv.cc
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XGaopSbrUSfPMgJgjqffhzolafE { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> fixed-conv.cc</span>
        &nbsp;&nbsp;
        46 lines (34 with data), 1.2 kB
      </h3>
...
43
44
45</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cm">/*</span>
...
</div><div id="l26" class="code_block"><span class="cp">#include &quot;fixed-conv.h&quot;</span>
</div><div id="l27" class="code_block">
</div><div id="l28" class="code_block"><span class="cp">#ifdef HAVE_HDF5</span>
</div><div id="l29" class="code_block"><span class="n">hid_t</span>
</div><div id="l30" class="code_block"><span class="n">hdf5_make_fixed_complex_type</span> <span class="p">(</span><span class="n">hid_t</span> <span class="n">num_type</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">)</span>
</div><div id="l31" class="code_block"><span class="p">{</span>
</div><div id="l32" class="code_block">  <span class="n">hid_t</span> <span class="n">type_id</span> <span class="o">=</span> <span class="n">H5Tcreate</span> <span class="p">(</span><span class="n">H5T_COMPOUND</span><span class="p">,</span> <span class="n">size</span> <span class="o">*</span> <span class="mi">2</span><span class="p">);</span>
</div><div id="l33" class="code_block">
</div><div id="l34" class="code_block">  <span class="n">H5Tinsert</span> <span class="p">(</span><span class="n">type_id</span><span class="p">,</span> <span class="s">&quot;real&quot;</span><span class="p">,</span> <span class="mi">0</span> <span class="o">*</span> <span class="n">size</span><span class="p">,</span> <span class="n">num_type</span><span class="p">);</span>
</div><div id="l35" class="code_block">  <span class="n">H5Tinsert</span> <span class="p">(</span><span class="n">type_id</span><span class="p">,</span> <span class="s">&quot;imag&quot;</span><span class="p">,</span> <span class="mi">1</span> <span class="o">*</span> <span class="n">size</span><span class="p">,</span> <span class="n">num_type</span><span class="p">);</span>
</div><div id="l36" class="code_block">
</div><div id="l37" class="code_block">  <span class="k">return</span> <span class="n">type_id</span><span class="p">;</span>
</div><div id="l38" class="code_block"><span class="p">}</span>
</div><div id="l39" class="code_block"><span class="cp">#endif</span>
</div><div id="l40" class="code_block">
</div><div id="l41" class="code_block"><span class="cm">/*</span>
</div><div id="l42" class="code_block"><span class="cm">;;; Local Variables: ***</span>
</div><div id="l43" class="code_block"><span class="cm">;;; mode: C++ ***</span>
</div><div id="l44" class="code_block"><span class="cm">;;; End: ***</span>
