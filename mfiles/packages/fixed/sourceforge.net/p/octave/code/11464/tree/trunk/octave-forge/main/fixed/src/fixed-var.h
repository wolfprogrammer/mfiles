...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/fixed-var.h
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XjySkzFstZxlOrxSIuKfcThQ { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> fixed-var.h</span>
        &nbsp;&nbsp;
        43 lines (31 with data), 1.1 kB
      </h3>
...
39
40
41</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cm">/*</span>
...
</div><div id="l26" class="code_block"><span class="cp">#if !defined (fixed_var_h)</span>
</div><div id="l27" class="code_block"><span class="cp">#define fixed_var_h 1</span>
</div><div id="l28" class="code_block">
</div><div id="l29" class="code_block"><span class="cp">#if !defined(fixed_var_cc)</span>
</div><div id="l30" class="code_block"><span class="k">extern</span> <span class="kt">int</span> <span class="o">&amp;</span><span class="n">Vfixed_point_print_width</span><span class="p">;</span>
</div><div id="l31" class="code_block"><span class="k">extern</span> <span class="kt">char</span> <span class="o">&amp;</span><span class="n">fixed_point_version</span><span class="p">;</span>
</div><div id="l32" class="code_block"><span class="k">extern</span> <span class="kt">char</span> <span class="o">&amp;</span><span class="n">fixed_point_library_version</span><span class="p">;</span>
</div><div id="l33" class="code_block"><span class="cp">#endif</span>
</div><div id="l34" class="code_block">
</div><div id="l35" class="code_block"><span class="cp">#endif</span>
</div><div id="l36" class="code_block">
</div><div id="l37" class="code_block"><span class="cm">/*</span>
</div><div id="l38" class="code_block"><span class="cm">;;; Local Variables: ***</span>
</div><div id="l39" class="code_block"><span class="cm">;;; mode: C++ ***</span>
</div><div id="l40" class="code_block"><span class="cm">;;; End: ***</span>
