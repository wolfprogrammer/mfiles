...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/Array-f.cc
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XfCBOdGMRQzCRURInTxvaou { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> Array-f.cc</span>
        &nbsp;&nbsp;
        90 lines (71 with data), 2.2 kB
      </h3>
...
87
88
89</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cm">/*</span>
...
</div><div id="l27" class="code_block"><span class="cp">#include &quot;int/fixed.h&quot;</span>
</div><div id="l28" class="code_block"><span class="cp">#include &quot;fixedComplex.h&quot;</span>
</div><div id="l29" class="code_block"><span class="c1">//#include &quot;fixedMatrix.h&quot;</span>
</div><div id="l30" class="code_block"><span class="c1">//#include &quot;fixedCMatrix.h&quot;</span>
</div><div id="l31" class="code_block">
</div><div id="l32" class="code_block"><span class="kr">inline</span> <span class="n">FixedPoint</span>
</div><div id="l33" class="code_block"><span class="n">xmin</span> <span class="p">(</span><span class="k">const</span> <span class="n">FixedPoint</span><span class="o">&amp;</span> <span class="n">x</span><span class="p">,</span> <span class="k">const</span> <span class="n">FixedPoint</span><span class="o">&amp;</span> <span class="n">y</span><span class="p">)</span>
</div><div id="l34" class="code_block"><span class="p">{</span>
</div><div id="l35" class="code_block">  <span class="k">return</span> <span class="n">x</span> <span class="o">&lt;=</span> <span class="n">y</span> <span class="o">?</span> <span class="n">x</span> <span class="o">:</span> <span class="n">y</span><span class="p">;</span>
</div><div id="l36" class="code_block"><span class="p">}</span>
</div><div id="l37" class="code_block">
</div><div id="l38" class="code_block"><span class="kr">inline</span> <span class="n">FixedPoint</span>
</div><div id="l39" class="code_block"><span class="n">xmax</span> <span class="p">(</span><span class="k">const</span> <span class="n">FixedPoint</span><span class="o">&amp;</span> <span class="n">x</span><span class="p">,</span> <span class="k">const</span> <span class="n">FixedPoint</span><span class="o">&amp;</span> <span class="n">y</span><span class="p">)</span>
</div><div id="l40" class="code_block"><span class="p">{</span>
</div><div id="l41" class="code_block">  <span class="k">return</span> <span class="n">x</span> <span class="o">&gt;=</span> <span class="n">y</span> <span class="o">?</span> <span class="n">x</span> <span class="o">:</span> <span class="n">y</span><span class="p">;</span>
</div><div id="l42" class="code_block"><span class="p">}</span>
</div><div id="l43" class="code_block">
</div><div id="l44" class="code_block"><span class="kr">inline</span> <span class="n">FixedPointComplex</span>
</div><div id="l45" class="code_block"><span class="n">xmin</span> <span class="p">(</span><span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">x</span><span class="p">,</span> <span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">y</span><span class="p">)</span>
</div><div id="l46" class="code_block"><span class="p">{</span>
</div><div id="l47" class="code_block">  <span class="k">return</span> <span class="n">x</span> <span class="o">&lt;=</span> <span class="n">y</span> <span class="o">?</span> <span class="n">x</span> <span class="o">:</span> <span class="n">y</span><span class="p">;</span>
</div><div id="l48" class="code_block"><span class="p">}</span>
</div><div id="l49" class="code_block">
</div><div id="l50" class="code_block"><span class="kr">inline</span> <span class="n">FixedPointComplex</span>
</div><div id="l51" class="code_block"><span class="n">xmax</span> <span class="p">(</span><span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">x</span><span class="p">,</span> <span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">y</span><span class="p">)</span>
</div><div id="l52" class="code_block"><span class="p">{</span>
</div><div id="l53" class="code_block">  <span class="k">return</span> <span class="n">x</span> <span class="o">&gt;=</span> <span class="n">y</span> <span class="o">?</span> <span class="n">x</span> <span class="o">:</span> <span class="n">y</span><span class="p">;</span>
</div><div id="l54" class="code_block"><span class="p">}</span>
</div><div id="l55" class="code_block">
</div><div id="l56" class="code_block"><span class="cp">#include &lt;octave/Array.h&gt;</span>
</div><div id="l57" class="code_block"><span class="cp">#include &lt;octave/Array.cc&gt;</span>
</div><div id="l58" class="code_block"><span class="cp">#include &lt;octave/MArray.h&gt;</span>
</div><div id="l59" class="code_block"><span class="cp">#include &lt;octave/MArray.cc&gt;</span>
</div><div id="l60" class="code_block">
</div><div id="l61" class="code_block"><span class="cp">#include &lt;octave/oct-sort.cc&gt;</span>
</div><div id="l62" class="code_block">
</div><div id="l63" class="code_block"><span class="k">static</span> <span class="kt">bool</span>
</div><div id="l64" class="code_block"><span class="k">operator</span> <span class="o">&lt;</span> <span class="p">(</span><span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">a</span><span class="p">,</span> <span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">b</span><span class="p">)</span>
</div><div id="l65" class="code_block"><span class="p">{</span>
</div><div id="l66" class="code_block">  <span class="k">return</span> <span class="p">((</span><span class="n">abs</span> <span class="p">(</span><span class="n">a</span><span class="p">)</span> <span class="o">&lt;</span> <span class="n">abs</span> <span class="p">(</span><span class="n">b</span><span class="p">))</span> <span class="o">||</span> <span class="p">((</span><span class="n">abs</span> <span class="p">(</span><span class="n">a</span><span class="p">)</span> <span class="o">==</span> <span class="n">abs</span> <span class="p">(</span><span class="n">b</span><span class="p">))</span> <span class="o">&amp;&amp;</span> 
</div><div id="l67" class="code_block">				    <span class="p">(</span><span class="n">arg</span> <span class="p">(</span><span class="n">a</span><span class="p">)</span> <span class="o">&lt;</span> <span class="n">arg</span> <span class="p">(</span><span class="n">b</span><span class="p">))));</span>
</div><div id="l68" class="code_block"><span class="p">}</span>
</div><div id="l69" class="code_block">
</div><div id="l70" class="code_block"><span class="k">static</span> <span class="kt">bool</span>
</div><div id="l71" class="code_block"><span class="k">operator</span> <span class="o">&gt;</span> <span class="p">(</span><span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">a</span><span class="p">,</span> <span class="k">const</span> <span class="n">FixedPointComplex</span><span class="o">&amp;</span> <span class="n">b</span><span class="p">)</span>
</div><div id="l72" class="code_block"><span class="p">{</span>
</div><div id="l73" class="code_block">  <span class="k">return</span> <span class="p">((</span><span class="n">abs</span> <span class="p">(</span><span class="n">a</span><span class="p">)</span> <span class="o">&gt;</span> <span class="n">abs</span> <span class="p">(</span><span class="n">b</span><span class="p">))</span> <span class="o">||</span> <span class="p">((</span><span class="n">abs</span> <span class="p">(</span><span class="n">a</span><span class="p">)</span> <span class="o">==</span> <span class="n">abs</span> <span class="p">(</span><span class="n">b</span><span class="p">))</span> <span class="o">&amp;&amp;</span> 
</div><div id="l74" class="code_block">				    <span class="p">(</span><span class="n">arg</span> <span class="p">(</span><span class="n">a</span><span class="p">)</span> <span class="o">&gt;</span> <span class="n">arg</span> <span class="p">(</span><span class="n">b</span><span class="p">))));</span>
</div><div id="l75" class="code_block"><span class="p">}</span>
</div><div id="l76" class="code_block">
</div><div id="l77" class="code_block"><span class="n">INSTANTIATE_ARRAY</span> <span class="p">(</span><span class="n">FixedPoint</span><span class="p">,</span> <span class="p">);</span>
</div><div id="l78" class="code_block"><span class="k">template</span> <span class="k">class</span> <span class="nc">MArray</span><span class="o">&lt;</span><span class="n">FixedPoint</span><span class="o">&gt;</span><span class="p">;</span>
</div><div id="l79" class="code_block"><span class="n">INSTANTIATE_MARRAY_FRIENDS</span> <span class="p">(</span><span class="n">FixedPoint</span><span class="p">,</span> <span class="p">)</span>
</div><div id="l80" class="code_block">
</div><div id="l81" class="code_block"><span class="n">INSTANTIATE_ARRAY</span> <span class="p">(</span><span class="n">FixedPointComplex</span><span class="p">,</span> <span class="p">);</span>
</div><div id="l82" class="code_block"><span class="k">template</span> <span class="k">class</span> <span class="nc">MArray</span><span class="o">&lt;</span><span class="n">FixedPointComplex</span><span class="o">&gt;</span><span class="p">;</span>
</div><div id="l83" class="code_block"><span class="n">INSTANTIATE_MARRAY_FRIENDS</span> <span class="p">(</span><span class="n">FixedPointComplex</span><span class="p">,</span> <span class="p">)</span>
</div><div id="l84" class="code_block">
</div><div id="l85" class="code_block"><span class="cm">/*</span>
</div><div id="l86" class="code_block"><span class="cm">;;; Local Variables: ***</span>
</div><div id="l87" class="code_block"><span class="cm">;;; mode: C++ ***</span>
</div><div id="l88" class="code_block"><span class="cm">;;; End: ***</span>
