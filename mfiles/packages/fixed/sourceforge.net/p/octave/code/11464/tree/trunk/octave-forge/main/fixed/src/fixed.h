...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/fixed.h
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XqjkcJuWdJvbNOHuilrPvJ { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> fixed.h</span>
        &nbsp;&nbsp;
...
50
51
52</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cm">/*</span>
...
</div><div id="l26" class="code_block"><span class="cp">#if !defined (fixed_h)</span>
</div><div id="l27" class="code_block"><span class="cp">#define fixed_h 1</span>
...
</div><div id="l31" class="code_block"><span class="cp">#include &quot;fixedRowVector.h&quot;</span>
</div><div id="l32" class="code_block"><span class="cp">#include &quot;fixedColVector.h&quot;</span>
</div><div id="l33" class="code_block"><span class="cp">#include &quot;fixedMatrix.h&quot;</span>
</div><div id="l34" class="code_block"><span class="cp">#include &quot;fixedNDArray.h&quot;</span>
</div><div id="l35" class="code_block"><span class="cp">#include &quot;fixedCRowVector.h&quot;</span>
</div><div id="l36" class="code_block"><span class="cp">#include &quot;fixedCColVector.h&quot;</span>
</div><div id="l37" class="code_block"><span class="cp">#include &quot;fixedCMatrix.h&quot;</span>
</div><div id="l38" class="code_block"><span class="cp">#include &quot;fixedCNDArray.h&quot;</span>
</div><div id="l39" class="code_block">
</div><div id="l40" class="code_block"><span class="cp">#include &quot;ov-fixed.h&quot;</span>
</div><div id="l41" class="code_block"><span class="cp">#include &quot;ov-fixed-mat.h&quot;</span>
</div><div id="l42" class="code_block"><span class="cp">#include &quot;ov-fixed-complex.h&quot;</span>
</div><div id="l43" class="code_block"><span class="cp">#include &quot;ov-fixed-cx-mat.h&quot;</span>
</div><div id="l44" class="code_block"><span class="cp">#include &quot;fixed-var.h&quot;</span>
</div><div id="l45" class="code_block">
</div><div id="l46" class="code_block"><span class="cp">#endif</span>
</div><div id="l47" class="code_block">
</div><div id="l48" class="code_block"><span class="cm">/*</span>
</div><div id="l49" class="code_block"><span class="cm">;;; Local Variables: ***</span>
</div><div id="l50" class="code_block"><span class="cm">;;; mode: C++ ***</span>
</div><div id="l51" class="code_block"><span class="cm">;;; End: ***</span>
