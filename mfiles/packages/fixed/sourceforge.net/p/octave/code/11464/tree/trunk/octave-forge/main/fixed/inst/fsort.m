...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/inst/fsort.m
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XcqcUBbyhtxFEIhIJEPhiQiiU { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> fsort.m</span>
        &nbsp;&nbsp;
        70 lines (66 with data), 2.1 kB
      </h3>
...
67
68
69</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cp">## Copyright (C) 2003  Motorola Inc</span>
...
</div><div id="l18" class="code_block"><span class="cp">## @deftypefn {Function File} {[@var{s}, @var{i}] =} fsort (@var{x})</span>
</div><div id="l19" class="code_block"><span class="cp">## Return a copy of the fixed point variable @var{x} with the elements</span>
</div><div id="l20" class="code_block"><span class="cp">## arranged in increasing order.  For matrices, @code{fsort} orders the </span>
</div><div id="l21" class="code_block"><span class="cp">## elements in each column.</span>
</div><div id="l22" class="code_block"><span class="cp">##</span>
</div><div id="l23" class="code_block"><span class="cp">## For example,</span>
</div><div id="l24" class="code_block"><span class="cp">##</span>
</div><div id="l25" class="code_block"><span class="cp">## @example</span>
</div><div id="l26" class="code_block"><span class="cp">## @group</span>
</div><div id="l27" class="code_block"><span class="cp">## fsort (fixed(4,0,[1, 2; 2, 3; 3, 1]))</span>
</div><div id="l28" class="code_block"><span class="cp">##     @result{}  1  1</span>
</div><div id="l29" class="code_block"><span class="cp">##         2  2</span>
</div><div id="l30" class="code_block"><span class="cp">##         3  3</span>
</div><div id="l31" class="code_block"><span class="cp">## @end group</span>
</div><div id="l32" class="code_block"><span class="cp">## @end example</span>
</div><div id="l33" class="code_block"><span class="cp">##</span>
</div><div id="l34" class="code_block"><span class="cp">## The @code{fsort} function may also be used to produce a matrix</span>
</div><div id="l35" class="code_block"><span class="cp">## containing the original row indices of the elements in the sorted</span>
</div><div id="l36" class="code_block"><span class="cp">## matrix.  For example,</span>
</div><div id="l37" class="code_block"><span class="cp">##</span>
</div><div id="l38" class="code_block"><span class="cp">## @example</span>
</div><div id="l39" class="code_block"><span class="cp">## @group</span>
</div><div id="l40" class="code_block"><span class="cp">## [s, i] = sort ([1, 2; 2, 3; 3, 1])</span>
</div><div id="l41" class="code_block"><span class="cp">##      @result{} s = 1  1</span>
</div><div id="l42" class="code_block"><span class="cp">##             2  2</span>
</div><div id="l43" class="code_block"><span class="cp">##             3  3</span>
</div><div id="l44" class="code_block"><span class="cp">##      @result{} i = 1  3</span>
</div><div id="l45" class="code_block"><span class="cp">##             2  1</span>
</div><div id="l46" class="code_block"><span class="cp">##             3  2</span>
</div><div id="l47" class="code_block"><span class="cp">## @end group</span>
</div><div id="l48" class="code_block"><span class="cp">## @end example</span>
</div><div id="l49" class="code_block"><span class="cp">## @end deftypefn</span>
</div><div id="l50" class="code_block">
</div><div id="l51" class="code_block"><span class="cp">## PKG_ADD: dispatch (&quot;sort&quot;, &quot;fsort&quot;, &quot;fixed scalar&quot;)</span>
</div><div id="l52" class="code_block"><span class="cp">## PKG_ADD: dispatch (&quot;sort&quot;, &quot;fsort&quot;, &quot;fixed matrix&quot;)</span>
</div><div id="l53" class="code_block"><span class="cp">## PKG_ADD: dispatch (&quot;sort&quot;, &quot;fsort&quot;, &quot;fixed complex&quot;)</span>
</div><div id="l54" class="code_block"><span class="cp">## PKG_ADD: dispatch (&quot;sort&quot;, &quot;fsort&quot;, &quot;fixed complex matrix&quot;)</span>
</div><div id="l55" class="code_block">
</div><div id="l56" class="code_block"><span class="n">function</span> <span class="p">[</span><span class="n">s</span><span class="p">,</span> <span class="n">i</span><span class="p">]</span> <span class="o">=</span> <span class="n">fsort</span> <span class="p">(</span><span class="n">x</span><span class="p">)</span>
</div><div id="l57" class="code_block">   <span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">isfixed</span><span class="p">(</span><span class="n">x</span><span class="p">))</span>
</div><div id="l58" class="code_block">     <span class="n">error</span><span class="p">(</span><span class="s">&quot;fsort: input argument not of fixed point type&quot;</span><span class="p">);</span>
</div><div id="l59" class="code_block">   <span class="n">endif</span>
</div><div id="l60" class="code_block">   <span class="p">[</span><span class="n">a</span><span class="p">,</span> <span class="n">i</span><span class="p">]</span> <span class="o">=</span> <span class="n">sort</span><span class="p">(</span><span class="n">x</span><span class="p">.</span><span class="n">x</span><span class="p">);</span>
</div><div id="l61" class="code_block">   <span class="k">if</span> <span class="n">isvector</span><span class="p">(</span><span class="n">a</span><span class="p">)</span>
</div><div id="l62" class="code_block">     <span class="n">s</span> <span class="o">=</span> <span class="n">x</span><span class="p">(</span><span class="n">i</span><span class="p">);</span>
</div><div id="l63" class="code_block">   <span class="k">else</span>
</div><div id="l64" class="code_block">     <span class="n">s</span> <span class="o">=</span> <span class="n">x</span><span class="p">;</span>
</div><div id="l65" class="code_block">     <span class="k">for</span> <span class="n">j</span><span class="o">=</span><span class="mi">1</span><span class="o">:</span><span class="n">size</span><span class="p">(</span><span class="n">i</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span>
</div><div id="l66" class="code_block">       <span class="n">s</span><span class="p">(</span><span class="o">:</span><span class="p">,</span><span class="n">j</span><span class="p">)</span> <span class="o">=</span> <span class="n">s</span><span class="p">(</span><span class="n">i</span><span class="p">(</span><span class="o">:</span><span class="p">,</span><span class="n">j</span><span class="p">),</span><span class="n">j</span><span class="p">);</span>
</div><div id="l67" class="code_block">     <span class="n">endfor</span>
</div><div id="l68" class="code_block">   <span class="n">endif</span>
</div><div id="l69" class="code_block"><span class="n">endfunction</span>
</div></pre></div>
</td></tr></table>
