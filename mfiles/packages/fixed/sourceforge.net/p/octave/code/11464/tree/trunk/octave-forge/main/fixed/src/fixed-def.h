...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/fixed-def.h
</title>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> fixed-def.h</span>
        &nbsp;&nbsp;
        80 lines (63 with data), 2.3 kB
      </h3>
...
76
77
78</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cm">/*</span>
...
</div><div id="l26" class="code_block"><span class="cp">#if !defined (fixed_def_h)</span>
</div><div id="l27" class="code_block"><span class="cp">#define fixed_def_h 1</span>
</div><div id="l28" class="code_block">
</div><div id="l29" class="code_block"><span class="cp">#include &quot;ov-fixed-mat.h&quot;</span>
</div><div id="l30" class="code_block"><span class="cp">#include &quot;ov-fixed-cx-mat.h&quot;</span>
</div><div id="l31" class="code_block">
</div><div id="l32" class="code_block"><span class="cp">#define __FIXED_SIGN_STR &quot;sign&quot;</span>
</div><div id="l33" class="code_block"><span class="cp">#define __FIXED_VALUE_STR &quot;x&quot;</span>
</div><div id="l34" class="code_block"><span class="cp">#define __FIXED_DECSIZE_STR &quot;dec&quot;</span>
</div><div id="l35" class="code_block"><span class="cp">#define __FIXED_INTSIZE_STR &quot;int&quot;</span>
</div><div id="l36" class="code_block">
</div><div id="l37" class="code_block"><span class="cp">#define FIXED_DEFUNOP_OP(name, t, op) \</span>
</div><div id="l38" class="code_block"><span class="cp">  UNOPDECL (name, a) \</span>
</div><div id="l39" class="code_block"><span class="cp">  { \</span>
</div><div id="l40" class="code_block"><span class="cp">      CAST_UNOP_ARG (const octave_ ## t&amp;); \</span>
</div><div id="l41" class="code_block"><span class="cp">      return new octave_ ## t (op v.t ## _value ()); \</span>
</div><div id="l42" class="code_block"><span class="cp">  }</span>
</div><div id="l43" class="code_block">
</div><div id="l44" class="code_block"><span class="cp">#define FIXED_DEFBINOP_OP(name, t1, t2, ret, op) \</span>
</div><div id="l45" class="code_block"><span class="cp">  BINOPDECL (name, a1, a2) \</span>
</div><div id="l46" class="code_block"><span class="cp">  { \</span>
</div><div id="l47" class="code_block"><span class="cp">    CAST_BINOP_ARGS (const octave_ ## t1&amp;, const octave_ ## t2&amp;); \</span>
</div><div id="l48" class="code_block"><span class="cp">    octave_value retval = new octave_ ## ret \</span>
</div><div id="l49" class="code_block"><span class="cp">      (v1.t1 ## _value () op v2.t2 ## _value ()); \</span>
</div><div id="l50" class="code_block"><span class="cp">    retval.maybe_mutate(); \</span>
</div><div id="l51" class="code_block"><span class="cp">    return retval; \</span>
</div><div id="l52" class="code_block"><span class="cp">  }</span>
</div><div id="l53" class="code_block">
</div><div id="l54" class="code_block"><span class="cp">#define FIXED_DEFBINOP_FN(name, t1, t2, ret, f) \</span>
</div><div id="l55" class="code_block"><span class="cp">  BINOPDECL (name, a1, a2) \</span>
</div><div id="l56" class="code_block"><span class="cp">  { \</span>
</div><div id="l57" class="code_block"><span class="cp">    CAST_BINOP_ARGS (const octave_ ## t1&amp;, const octave_ ## t2&amp;); \</span>
</div><div id="l58" class="code_block"><span class="cp">    octave_value retval = new octave_ ## ret \</span>
</div><div id="l59" class="code_block"><span class="cp">      (f (v1.t1 ## _value (), v2.t2 ## _value ())); \</span>
</div><div id="l60" class="code_block"><span class="cp">    retval.maybe_mutate(); \</span>
</div><div id="l61" class="code_block"><span class="cp">    return retval; \</span>
</div><div id="l62" class="code_block"><span class="cp">  }</span>
</div><div id="l63" class="code_block">
</div><div id="l64" class="code_block"><span class="cp">#define FIXED_DEFCATOP_FN(name, t1, t2, e1, e2, ret, f)	\</span>
</div><div id="l65" class="code_block"><span class="cp">  CATOPDECL (name, a1, a2)	     \</span>
</div><div id="l66" class="code_block"><span class="cp">  { \</span>
</div><div id="l67" class="code_block"><span class="cp">    CAST_BINOP_ARGS (octave_ ## t1&amp;, const octave_ ## t2&amp;); \</span>
</div><div id="l68" class="code_block"><span class="cp">    return new octave_ ## ret (v1.e1 ## _value (). f (v2.e2 ## _value (), ra_idx)); \</span>
</div><div id="l69" class="code_block"><span class="cp">  }</span>
</div><div id="l70" class="code_block">
</div><div id="l71" class="code_block"><span class="cp">#define FIXED_INSTALL_CATOP(t1, t2, f) INSTALL_CATOP(t1, t2, f) </span>
</div><div id="l72" class="code_block"><span class="cp">#endif</span>
</div><div id="l73" class="code_block">
</div><div id="l74" class="code_block"><span class="cm">/*</span>
</div><div id="l75" class="code_block"><span class="cm">;;; Local Variables: ***</span>
</div><div id="l76" class="code_block"><span class="cm">;;; mode: C++ ***</span>
</div><div id="l77" class="code_block"><span class="cm">;;; End: ***</span>
</div><div id="l78" class="code_block"><span class="cm">*/</span>
</div></pre></div>
</td></tr></table>
