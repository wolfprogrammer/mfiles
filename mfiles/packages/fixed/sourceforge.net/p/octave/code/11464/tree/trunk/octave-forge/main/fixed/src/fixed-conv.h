...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/fixed-conv.h
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XzSpeLNWGpIOTJHJyNfjNE { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> fixed-conv.h</span>
        &nbsp;&nbsp;
        87 lines (72 with data), 2.0 kB
      </h3>
...
84
85
86</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cm">/*</span>
...
</div><div id="l26" class="code_block"><span class="cp">#if !defined (fixed_conv_h)</span>
</div><div id="l27" class="code_block"><span class="cp">#define fixed_conv_h 1</span>
...
</div><div id="l31" class="code_block"><span class="cp">#ifdef HAVE_HDF5</span>
</div><div id="l32" class="code_block"><span class="cp">#include &lt;hdf5.h&gt;</span>
</div><div id="l33" class="code_block"><span class="n">hid_t</span> <span class="n">hdf5_make_fixed_complex_type</span> <span class="p">(</span><span class="n">hid_t</span> <span class="n">num_type</span><span class="p">,</span> <span class="kt">int</span> <span class="n">size</span><span class="p">);</span>
</div><div id="l34" class="code_block"><span class="cp">#endif</span>
</div><div id="l35" class="code_block">
</div><div id="l36" class="code_block"><span class="cp">#define LS_DO_WRITE(TYPE, data, size, len, stream) \</span>
</div><div id="l37" class="code_block"><span class="cp">  do \</span>
</div><div id="l38" class="code_block"><span class="cp">    { \</span>
</div><div id="l39" class="code_block"><span class="cp">      if (len &gt; 0) \</span>
</div><div id="l40" class="code_block"><span class="cp">	{ \</span>
</div><div id="l41" class="code_block"><span class="cp">	  TYPE *ptr = new TYPE [len]; \</span>
</div><div id="l42" class="code_block"><span class="cp">	  for (int i = 0; i &lt; len; i++) \</span>
</div><div id="l43" class="code_block"><span class="cp">	    ptr[i] = X_CAST (TYPE, (data)[i]); \</span>
</div><div id="l44" class="code_block"><span class="cp">	  stream.write (X_CAST (char *, ptr), size * len); \</span>
</div><div id="l45" class="code_block"><span class="cp">	  delete [] ptr ; \</span>
</div><div id="l46" class="code_block"><span class="cp">	} \</span>
</div><div id="l47" class="code_block"><span class="cp">    } \</span>
</div><div id="l48" class="code_block"><span class="cp">  while (0)</span>
</div><div id="l49" class="code_block">
</div><div id="l50" class="code_block"><span class="cp">#define LS_DO_READ(TYPE, swap, data, size, len, stream) \</span>
</div><div id="l51" class="code_block"><span class="cp">  do \</span>
</div><div id="l52" class="code_block"><span class="cp">    { \</span>
</div><div id="l53" class="code_block"><span class="cp">      if (len &gt; 0) \</span>
</div><div id="l54" class="code_block"><span class="cp">	{ \</span>
</div><div id="l55" class="code_block"><span class="cp">	  TYPE *ptr = new TYPE [len]; \</span>
</div><div id="l56" class="code_block"><span class="cp">	  stream.read (X_CAST (char *, ptr), size * len); \</span>
</div><div id="l57" class="code_block"><span class="cp">	  if (swap) \</span>
</div><div id="l58" class="code_block"><span class="cp">	    swap_bytes &lt;size&gt; (ptr, len); \</span>
</div><div id="l59" class="code_block"><span class="cp">	  for (int i = 0; i &lt; len; i++) \</span>
</div><div id="l60" class="code_block"><span class="cp">	    (data)[i] = ptr[i]; \</span>
</div><div id="l61" class="code_block"><span class="cp">	  delete [] ptr ; \</span>
</div><div id="l62" class="code_block"><span class="cp">	} \</span>
</div><div id="l63" class="code_block"><span class="cp">    } \</span>
</div><div id="l64" class="code_block"><span class="cp">  while (0)</span>
</div><div id="l65" class="code_block">
</div><div id="l66" class="code_block"><span class="cp">#define LS_DO_READ_1(data, len, stream) \</span>
</div><div id="l67" class="code_block"><span class="cp">  do \</span>
</div><div id="l68" class="code_block"><span class="cp">    { \</span>
</div><div id="l69" class="code_block"><span class="cp">      if (len &gt; 0) \</span>
</div><div id="l70" class="code_block"><span class="cp">	{ \</span>
</div><div id="l71" class="code_block"><span class="cp">	  char *ptr = new char [len]; \</span>
</div><div id="l72" class="code_block"><span class="cp">	  stream.read (X_CAST (char *, ptr), len); \</span>
</div><div id="l73" class="code_block"><span class="cp">	  for (int i = 0; i &lt; len; i++) \</span>
</div><div id="l74" class="code_block"><span class="cp">	    (data)[i] = ptr[i]; \</span>
</div><div id="l75" class="code_block"><span class="cp">	  delete [] ptr ; \</span>
</div><div id="l76" class="code_block"><span class="cp">	} \</span>
</div><div id="l77" class="code_block"><span class="cp">    } \</span>
</div><div id="l78" class="code_block"><span class="cp">  while (0)</span>
...
</div><div id="l83" class="code_block"><span class="cm">;;; Local Variables: ***</span>
</div><div id="l84" class="code_block"><span class="cm">;;; mode: C++ ***</span>
</div><div id="l85" class="code_block"><span class="cm">;;; End: ***</span>
