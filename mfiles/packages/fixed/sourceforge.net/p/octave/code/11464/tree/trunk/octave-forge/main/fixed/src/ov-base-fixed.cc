...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/ov-base-fixed.cc
</title>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> ov-base-fixed.cc</span>
        &nbsp;&nbsp;
        115 lines (92 with data), 2.7 kB
      </h3>
...
</div><div id="l33" class="code_block"><span class="k">template</span> <span class="o">&lt;</span><span class="k">class</span> <span class="nc">ST</span><span class="o">&gt;</span>
</div><div id="l34" class="code_block"><span class="n">octave_value_list</span>
</div><div id="l35" class="code_block"><span class="n">octave_base_fixed</span><span class="o">&lt;</span><span class="n">ST</span><span class="o">&gt;::</span><span class="n">dotref</span> <span class="p">(</span><span class="k">const</span> <span class="n">octave_value_list</span><span class="o">&amp;</span> <span class="n">idx</span><span class="p">)</span>
...
</div><div id="l44" class="code_block">    <span class="n">retval</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="o">=</span> <span class="n">octave_value</span> <span class="p">(</span><span class="n">scalar</span><span class="p">.</span><span class="n">sign</span><span class="p">());</span>
...
</div><div id="l46" class="code_block">    <span class="n">retval</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="o">=</span> <span class="n">octave_value</span> <span class="p">(</span><span class="n">scalar</span><span class="p">.</span><span class="n">fixedpoint</span><span class="p">());</span>
...
</div><div id="l48" class="code_block">    <span class="n">retval</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="o">=</span> <span class="n">octave_value</span> <span class="p">(</span><span class="n">scalar</span><span class="p">.</span><span class="n">getdecsize</span><span class="p">());</span>
...
</div><div id="l50" class="code_block">    <span class="n">retval</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span> <span class="o">=</span> <span class="n">octave_value</span> <span class="p">(</span><span class="n">scalar</span><span class="p">.</span><span class="n">getintsize</span><span class="p">());</span>
...
</div><div id="l57" class="code_block"><span class="k">template</span> <span class="o">&lt;</span><span class="k">class</span> <span class="nc">ST</span><span class="o">&gt;</span>
</div><div id="l58" class="code_block"><span class="n">octave_value</span>
</div><div id="l59" class="code_block"><span class="n">octave_base_fixed</span><span class="o">&lt;</span><span class="n">ST</span><span class="o">&gt;::</span><span class="n">subsref</span> <span class="p">(</span><span class="k">const</span> <span class="n">std</span><span class="o">::</span><span class="n">string</span><span class="o">&amp;</span> <span class="n">type</span><span class="p">,</span>
...
</div><div id="l92" class="code_block"><span class="k">template</span> <span class="o">&lt;</span><span class="k">class</span> <span class="nc">ST</span><span class="o">&gt;</span>
</div><div id="l93" class="code_block"><span class="kt">void</span>
</div><div id="l94" class="code_block"><span class="n">octave_base_fixed</span><span class="o">&lt;</span><span class="n">ST</span><span class="o">&gt;::</span><span class="n">print</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">ostream</span><span class="o">&amp;</span> <span class="n">os</span><span class="p">,</span> <span class="kt">bool</span> <span class="n">pr_as_read_syntax</span><span class="p">)</span> <span class="k">const</span>
</div><div id="l95" class="code_block"><span class="p">{</span>
</div><div id="l96" class="code_block">  <span class="n">print_raw</span> <span class="p">(</span><span class="n">os</span><span class="p">,</span> <span class="n">pr_as_read_syntax</span><span class="p">);</span>
</div><div id="l97" class="code_block">  <span class="n">newline</span> <span class="p">(</span><span class="n">os</span><span class="p">);</span>
</div><div id="l98" class="code_block"><span class="p">}</span>
</div><div id="l99" class="code_block">
</div><div id="l100" class="code_block"><span class="k">template</span> <span class="o">&lt;</span><span class="k">class</span> <span class="nc">ST</span><span class="o">&gt;</span>
</div><div id="l101" class="code_block"><span class="kt">bool</span>
</div><div id="l102" class="code_block"><span class="n">octave_base_fixed</span><span class="o">&lt;</span><span class="n">ST</span><span class="o">&gt;::</span><span class="n">print_name_tag</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">ostream</span><span class="o">&amp;</span> <span class="n">os</span><span class="p">,</span>
</div><div id="l103" class="code_block">					<span class="k">const</span> <span class="n">std</span><span class="o">::</span><span class="n">string</span><span class="o">&amp;</span> <span class="n">name</span><span class="p">)</span> <span class="k">const</span>
</div><div id="l104" class="code_block"><span class="p">{</span>
</div><div id="l105" class="code_block">  <span class="n">indent</span> <span class="p">(</span><span class="n">os</span><span class="p">);</span>
</div><div id="l106" class="code_block">  <span class="n">os</span> <span class="o">&lt;&lt;</span> <span class="n">name</span> <span class="o">&lt;&lt;</span> <span class="s">&quot; = &quot;</span><span class="p">;</span>
</div><div id="l107" class="code_block">  <span class="k">return</span> <span class="kc">false</span><span class="p">;</span>    
