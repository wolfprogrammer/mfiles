...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/examples/testfixed.m
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XXhlEDtLNoWLfYqIQZXOu { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> testfixed.m</span>
        &nbsp;&nbsp;
...
</div><div id="l18" class="code_block"><span class="cp">## @deftypefn {Function File} {} testfixed ()</span>
</div><div id="l19" class="code_block"><span class="cp">## </span>
</div><div id="l20" class="code_block"><span class="cp">## Tiny function file demonstrating the use of functions that are defined</span>
</div><div id="l21" class="code_block"><span class="cp">## once with floating and fixed point types.</span>
</div><div id="l22" class="code_block"><span class="cp">## @end deftypefn</span>
</div><div id="l23" class="code_block">
</div><div id="l24" class="code_block"><span class="n">function</span> <span class="p">[</span><span class="n">b</span><span class="p">,</span> <span class="n">bf</span><span class="p">]</span> <span class="o">=</span> <span class="n">testfixed</span><span class="p">(</span><span class="n">is</span><span class="p">,</span><span class="n">ds</span><span class="p">,</span><span class="n">n</span><span class="p">)</span>
</div><div id="l25" class="code_block"><span class="n">a</span> <span class="o">=</span> <span class="n">randn</span><span class="p">(</span><span class="n">n</span><span class="p">,</span><span class="n">n</span><span class="p">);</span>
</div><div id="l26" class="code_block"><span class="n">af</span> <span class="o">=</span> <span class="n">fixed</span><span class="p">(</span><span class="n">is</span><span class="p">,</span><span class="n">ds</span><span class="p">,</span><span class="n">a</span><span class="p">);</span>
</div><div id="l27" class="code_block"><span class="n">b</span> <span class="o">=</span> <span class="n">myfunc</span><span class="p">(</span><span class="n">a</span><span class="p">,</span><span class="n">a</span><span class="p">);</span>
</div><div id="l28" class="code_block"><span class="n">bf</span> <span class="o">=</span> <span class="n">myfunc</span><span class="p">(</span><span class="n">af</span><span class="p">,</span><span class="n">af</span><span class="p">);</span>
</div><div id="l29" class="code_block"><span class="n">endfunction</span>
</div><div id="l30" class="code_block">
</div><div id="l31" class="code_block"><span class="n">function</span> <span class="n">y</span> <span class="o">=</span> <span class="n">myfunc</span><span class="p">(</span><span class="n">a</span><span class="p">,</span><span class="n">b</span><span class="p">)</span>
</div><div id="l32" class="code_block"><span class="n">y</span> <span class="o">=</span> <span class="n">a</span> <span class="o">+</span> <span class="n">b</span><span class="p">;</span>
