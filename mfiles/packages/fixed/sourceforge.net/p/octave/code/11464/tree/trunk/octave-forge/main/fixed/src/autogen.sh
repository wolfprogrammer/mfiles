...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/src/autogen.sh
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XhMayyuaiVOfGqhDQFUiJDo { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> autogen.sh</span>
        &nbsp;&nbsp;
        24 lines (20 with data), 569 Bytes
      </h3>
...
21
22
23</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="c">#! /bin/sh</span>
</div><div id="l2" class="code_block">
</div><div id="l3" class="code_block"><span class="c">## Generate ./configure</span>
</div><div id="l4" class="code_block">rm -f configure.in
</div><div id="l5" class="code_block"><span class="nb">echo</span> <span class="s2">&quot;dnl --- DO NOT EDIT --- Automatically generated by autogen.sh&quot;</span> &gt; configure.in
</div><div id="l6" class="code_block">cat configure.base &gt;&gt; configure.in
</div><div id="l7" class="code_block">cat <span class="s">&lt;&lt;EOF &gt;&gt; configure.in</span>
</div><div id="l8" class="code_block"><span class="s">  AC_OUTPUT(\$CONFIGURE_OUTPUTS)</span>
</div><div id="l9" class="code_block"><span class="s">  dnl XXX FIXME XXX chmod is not in autoconf&#39;s list of portable functions</span>
</div><div id="l10" class="code_block">
</div><div id="l11" class="code_block"><span class="s">  echo &quot; &quot;</span>
</div><div id="l12" class="code_block"><span class="s">  AC_MSG_RESULT([\$STATUS_MSG])</span>
</div><div id="l13" class="code_block"><span class="s">  echo &quot; &quot;</span>
</div><div id="l14" class="code_block"><span class="s">EOF</span>
</div><div id="l15" class="code_block">
</div><div id="l16" class="code_block">autoconf configure.in &gt; configure.tmp
</div><div id="l17" class="code_block"><span class="k">if</span> <span class="o">[</span> diff configure.tmp configure &gt; /dev/null 2&gt;&amp;1 <span class="o">]</span>; <span class="k">then</span>
</div><div id="l18" class="code_block"><span class="k">  </span>rm -f configure.tmp;
</div><div id="l19" class="code_block"><span class="k">else</span>
</div><div id="l20" class="code_block"><span class="k">  </span>mv -f configure.tmp configure
</div><div id="l21" class="code_block">  chmod 0755 configure
</div><div id="l22" class="code_block"><span class="k">fi</span>
</div><div id="l23" class="code_block">rm -f configure.in
</div></pre></div>
</td></tr></table>
