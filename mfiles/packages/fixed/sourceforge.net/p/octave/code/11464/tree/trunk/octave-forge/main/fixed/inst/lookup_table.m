...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/inst/lookup_table.m
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XbiQzvkwwPZAghrQKtELAfNfU { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> lookup_table.m</span>
        &nbsp;&nbsp;
        55 lines (52 with data), 2.2 kB
      </h3>
...
52
53
54</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cp">## Copyright (C) 2003  Motorola Inc</span>
...
</div><div id="l18" class="code_block"><span class="cp">## @deftypefn {Function File} {@var{y} =} lookup_table (@var{table}, @var{x})</span>
</div><div id="l19" class="code_block"><span class="cp">## @deftypefnx {Function File} {@var{y} =} lookup_table (@var{table}, @var{x}, @var{interp}, @var{extrap})</span>
</div><div id="l20" class="code_block"><span class="cp">## Using the lookup table created by @dfn{create_lookup_table}, find the value</span>
</div><div id="l21" class="code_block"><span class="cp">## @var{y} corresponding to @var{x}. With two arguments the lookup is done</span>
</div><div id="l22" class="code_block"><span class="cp">## to the nearest value below in the table less than the desired value. With</span>
</div><div id="l23" class="code_block"><span class="cp">## three arguments a simple linear interpolation is performed. With four</span>
</div><div id="l24" class="code_block"><span class="cp">## arguments an extrapolation is also performed. The exact values of arguments</span>
</div><div id="l25" class="code_block"><span class="cp">## three and four are irrelevant, as only there presence detremines whether</span>
</div><div id="l26" class="code_block"><span class="cp">## interpolation and/or extrapolation are used.</span>
</div><div id="l27" class="code_block"><span class="cp">## @end deftypefn</span>
</div><div id="l28" class="code_block">
</div><div id="l29" class="code_block"><span class="n">function</span> <span class="n">y</span> <span class="o">=</span> <span class="n">lookup_table</span> <span class="p">(</span><span class="n">table</span><span class="p">,</span> <span class="n">x</span><span class="p">,</span> <span class="n">interp</span><span class="p">,</span> <span class="n">extrap</span><span class="p">);</span>
</div><div id="l30" class="code_block">  <span class="k">if</span> <span class="p">(</span><span class="n">nargin</span> <span class="o">&lt;</span> <span class="mi">2</span><span class="p">)</span>
</div><div id="l31" class="code_block">    <span class="n">error</span><span class="p">(</span><span class="s">&quot;lookup_table: needs two or more arguments&quot;</span><span class="p">);</span>
</div><div id="l32" class="code_block">  <span class="k">else</span> 
</div><div id="l33" class="code_block">    <span class="n">idx</span> <span class="o">=</span> <span class="n">lookup</span><span class="p">(</span><span class="n">table</span><span class="p">.</span><span class="n">x</span><span class="p">,</span> <span class="n">x</span><span class="p">);</span>
</div><div id="l34" class="code_block">    <span class="k">if</span> <span class="p">(</span><span class="n">nargin</span> <span class="o">==</span> <span class="mi">2</span><span class="p">)</span>
</div><div id="l35" class="code_block">      <span class="n">y</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">y</span> <span class="p">(</span><span class="n">max</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span><span class="n">idx</span><span class="p">));</span>
</div><div id="l36" class="code_block">    <span class="k">else</span>
</div><div id="l37" class="code_block">      <span class="n">len</span> <span class="o">=</span> <span class="n">length</span><span class="p">(</span><span class="n">table</span><span class="p">.</span><span class="n">x</span><span class="p">);</span>
</div><div id="l38" class="code_block">      <span class="n">before</span> <span class="o">=</span> <span class="n">find</span><span class="p">(</span><span class="n">idx</span> <span class="o">==</span> <span class="mi">0</span><span class="p">);</span>
</div><div id="l39" class="code_block">      <span class="n">after</span> <span class="o">=</span> <span class="n">find</span><span class="p">(</span><span class="n">idx</span> <span class="o">==</span> <span class="n">len</span><span class="p">);</span>
</div><div id="l40" class="code_block">      <span class="n">idx</span> <span class="o">=</span> <span class="n">max</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span><span class="n">min</span><span class="p">(</span><span class="n">idx</span><span class="p">,</span> <span class="n">len</span><span class="o">-</span><span class="mi">1</span><span class="p">));</span>
</div><div id="l41" class="code_block">      <span class="n">xl</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">x</span><span class="p">(</span><span class="n">idx</span><span class="p">);</span>
</div><div id="l42" class="code_block">      <span class="n">yl</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">y</span><span class="p">(</span><span class="n">idx</span><span class="p">);</span>
</div><div id="l43" class="code_block">      <span class="n">xu</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">x</span><span class="p">(</span><span class="n">idx</span><span class="o">+</span><span class="mi">1</span><span class="p">);</span>
</div><div id="l44" class="code_block">      <span class="n">yu</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">y</span><span class="p">(</span><span class="n">idx</span><span class="o">+</span><span class="mi">1</span><span class="p">);</span>
</div><div id="l45" class="code_block"><span class="cp">      ## Careful with the order of this interpolation to avoid underflow</span>
</div><div id="l46" class="code_block"><span class="cp">      ## in fixed point calculations.</span>
</div><div id="l47" class="code_block">      <span class="n">y</span> <span class="o">=</span> <span class="p">(</span> <span class="n">yl</span> <span class="o">+</span> <span class="p">(</span><span class="n">yu</span> <span class="o">-</span> <span class="n">yl</span><span class="p">)</span> <span class="p">.</span><span class="o">/</span> <span class="p">(</span><span class="n">xu</span> <span class="o">-</span> <span class="n">xl</span><span class="p">)</span> <span class="p">.</span><span class="o">*</span> <span class="p">(</span><span class="n">x</span> <span class="o">-</span> <span class="n">xl</span><span class="p">));</span>
</div><div id="l48" class="code_block">      <span class="k">if</span> <span class="p">(</span><span class="n">nargin</span> <span class="o">&lt;</span> <span class="mi">4</span><span class="p">)</span>
</div><div id="l49" class="code_block">	<span class="n">y</span><span class="p">(</span><span class="n">before</span><span class="p">)</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">y</span><span class="p">(</span><span class="mi">1</span><span class="p">);</span>
</div><div id="l50" class="code_block">	<span class="n">y</span><span class="p">(</span><span class="n">after</span><span class="p">)</span> <span class="o">=</span> <span class="n">table</span><span class="p">.</span><span class="n">y</span><span class="p">(</span><span class="n">len</span><span class="p">);</span>
</div><div id="l51" class="code_block">      <span class="n">endif</span>
</div><div id="l52" class="code_block">    <span class="n">endif</span>
</div><div id="l53" class="code_block">  <span class="n">endif</span>
</div><div id="l54" class="code_block"><span class="n">endfunction</span>
</div></pre></div>
</td></tr></table>
