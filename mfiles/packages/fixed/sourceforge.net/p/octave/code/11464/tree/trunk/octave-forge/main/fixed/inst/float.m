...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/inst/float.m
</title>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> float.m</span>
        &nbsp;&nbsp;
...
30
31
32</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cp">## Copyright (C) 2003  Motorola Inc</span>
...
</div><div id="l18" class="code_block"><span class="cp">## @deftypefn {Function File} {@var{y} =} float (@var{x})</span>
</div><div id="l19" class="code_block"><span class="cp">## Converts a fixed point object to the equivalent floating point object. This</span>
</div><div id="l20" class="code_block"><span class="cp">## is equivalent to @code{@var{x}.x} if @code{isfixed(@var{x})} returns true,</span>
</div><div id="l21" class="code_block"><span class="cp">## and returns @var{x} otherwise.</span>
</div><div id="l22" class="code_block"><span class="cp">## @end deftypefn</span>
</div><div id="l23" class="code_block">
</div><div id="l24" class="code_block"><span class="n">function</span> <span class="n">y</span> <span class="o">=</span> <span class="kt">float</span> <span class="p">(</span><span class="n">x</span><span class="p">)</span>
</div><div id="l25" class="code_block">
</div><div id="l26" class="code_block">  <span class="k">if</span> <span class="n">isfixed</span><span class="p">(</span><span class="n">x</span><span class="p">)</span>
</div><div id="l27" class="code_block">    <span class="n">y</span> <span class="o">=</span> <span class="n">x</span><span class="p">.</span><span class="n">x</span><span class="p">;</span>
</div><div id="l28" class="code_block">  <span class="k">else</span>
</div><div id="l29" class="code_block">    <span class="n">y</span> <span class="o">=</span> <span class="n">x</span><span class="p">;</span>
</div><div id="l30" class="code_block">  <span class="n">endif</span>
</div><div id="l31" class="code_block">
</div><div id="l32" class="code_block"><span class="n">endfunction</span>
</div></pre></div>
</td></tr></table>
