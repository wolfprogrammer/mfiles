...
<!--[if (gt IE 9)|!(IE)]>--> <html lang="en" class="no-js"> <!--<![endif]-->
  ...
  Octave Forge / Code /
  [r11464]
  /trunk/octave-forge/main/fixed/inst/create_lookup_table.m
</title>
...
#page-body.project---init-- #content_base {margin-top: 0; }
    ...
    <link rel="alternate" type="application/atom+xml" title="Atom" href="/p/octave/code/feed.atom"/>
      ...
      <style>.XJBvpvZHPInelLdReOxyEg { display:none }</style>
...
<a href="/p/octave/code/11464/log/">
  <b data-icon="N" class="ico ico-history" title="History"> </b> History
    ...
    <div class="clip grid-19">
      <h3>
        <span class="ico-l"><b data-icon="n" class="ico ico-table"></b> create_lookup_table.m</span>
        &nbsp;&nbsp;
...
31
32
33</pre></div></td><td class="code"><div class="codehilite"><pre><div id="l1" class="code_block"><span class="cp">## Copyright (C) 2003  Motorola Inc</span>
...
</div><div id="l18" class="code_block"><span class="cp">## @deftypefn {Function File} {@var{table} =} create_lookup_table (@var{x}, @var{y})</span>
</div><div id="l19" class="code_block"><span class="cp">## Creates a lookup table betwen the vectors @var{x} and @var{y}. If @var{x}</span>
</div><div id="l20" class="code_block"><span class="cp">## is not in increasing order, the vectors are sorted before being stored.</span>
</div><div id="l21" class="code_block"><span class="cp">## @end deftypefn</span>
</div><div id="l22" class="code_block">
</div><div id="l23" class="code_block"><span class="n">function</span> <span class="n">table</span> <span class="o">=</span> <span class="n">create_lookup_table</span> <span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">)</span>
</div><div id="l24" class="code_block">  <span class="k">if</span> <span class="n">any</span><span class="p">(</span><span class="n">size</span><span class="p">(</span><span class="n">x</span><span class="p">)</span> <span class="o">!=</span> <span class="n">size</span><span class="p">(</span><span class="n">y</span><span class="p">))</span>
</div><div id="l25" class="code_block">    <span class="n">error</span><span class="p">(</span><span class="s">&quot;create_lookup_table: tables must have the same dimension&quot;</span><span class="p">);</span>
</div><div id="l26" class="code_block">  <span class="n">elseif</span> <span class="o">!</span> <span class="n">isvector</span><span class="p">(</span><span class="n">x</span><span class="p">)</span>
</div><div id="l27" class="code_block">    <span class="n">error</span><span class="p">(</span><span class="s">&quot;create_lookup_table: tables must be vectors&quot;</span><span class="p">);</span>
</div><div id="l28" class="code_block">  <span class="k">else</span>
</div><div id="l29" class="code_block"><span class="cp">    ## This assumes that fsort is overloading sort for fixed point types</span>
</div><div id="l30" class="code_block">    <span class="p">[</span><span class="n">table</span><span class="p">.</span><span class="n">x</span><span class="p">,</span> <span class="n">idx</span><span class="p">]</span> <span class="o">=</span> <span class="n">sort</span><span class="p">(</span><span class="n">x</span><span class="p">);</span>
</div><div id="l31" class="code_block">    <span class="n">table</span><span class="p">.</span><span class="n">y</span> <span class="o">=</span> <span class="n">y</span><span class="p">(</span><span class="n">idx</span><span class="p">);</span>
</div><div id="l32" class="code_block">  <span class="n">endif</span>
</div><div id="l33" class="code_block"><span class="n">endfunction</span>
</div></pre></div>
</td></tr></table>
