...
" Maintainer:	Caio Rodrigues - caiorss.rodrigues@gmail.com
...
syn keyword matlabLabel	 		endswitch endfor endwhile endfunction global break endif
...
"" Highlight the most importants keywords of Octave
syn keyword matlabScope			all ans fprintf printf typeinfo type clear clc  pwd  disp home cd pkg load warning error 
syn keyword matlabScope			linspace logspace plot gplot print 
syn keyword matlabScope			pi  eps  flops  inf  NaN  nan  i  j  nargin  nargout realmin realmax true false
