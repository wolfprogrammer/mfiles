...
map  k
map  l
nmap <silent>  :silent :nohlsearch " Apaga resultado da busca
...
set mouse=a
set path=.,/usr/include,,,~/pic-sdcc/include/pic16f,/usr/share/sdcc/include,/usr/share/sdcc/include/pic,/usr/share/sdcc/include/pic16
...
set shortmess=aoO
badd +45 ~/mfiles/workspace.m
badd +36 ~/mfiles/ed.m
badd +1 ~/mfiles/matlab.vim
badd +8 ~/mfiles/plt.m
badd +2 ~/mfiles/edvector.m
badd +1 ~/mfiles/edv.m
badd +8 ~/mfiles/lookfor2.m
badd +0 ~/mfiles/search.m
silent! argdel *
edit ~/mfiles/workspace.m
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 111 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 43 + 78) / 157)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((23 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
let s:c = 90 - ((24 * winwidth(0) + 78) / 157)
if s:c > 0
